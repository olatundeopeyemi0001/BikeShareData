...
def station_stats(df):
    ...
    # TO DO: display most commonly used start station/// mcus is equal to Most Common Used Satrt Station
...
def display_data_request(df):
    ...
    view_data = input('\nwould you be willing to view 10 rows of individual trip data? enter yes or no').lower()
    start_loc= 0
    while (view_data != 'no'):
